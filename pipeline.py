...
for round_idx in range(args.total_round):
    if "base" in args.model:
        os.system(
            "srun --job-name=train_{}_{}-pooling_{}_round{} --nodes=1 --gpus=8 --mem=300G --exclusive bash train.t5.base.sh {} {} {} {}".
            format(args.model,args.pooling,args.datasets,round_idx,args.model,args.pooling,args.datasets,round_idx) )
        os.system(
            "srun --job-name=inference_{}_{}-pooling_{}_round{} --nodes=1 --gpus=8 --mem=300G --exclusive bash inference.t5.base.sh {} {} {} {}".
            format(args.model,args.pooling,args.datasets,round_idx,args.model,args.pooling,args.datasets,round_idx) )
    elif "large" in args.model:
        os.system(
            "srun --job-name=train_{}_{}-pooling_{}_round{} --nodes=1 --gpus=8 --mem=300G --exclusive bash train.t5.large.sh {} {} {} {}".
            format(args.model,args.pooling,args.datasets,round_idx,args.model,args.pooling,args.datasets,round_idx) )
        os.system(
            "srun --job-name=inference_{}_{}-pooling_{}_round{} --nodes=1 --gpus=8 --mem=300G --exclusive bash inference.t5.large.sh {} {} {} {}".
            format(args.model,args.pooling,args.datasets,round_idx,args.model,args.pooling,args.datasets,round_idx) )
    generated_qrels_dir="{}/round{}".format(qrels_dir,round_idx)
    if not os.path.exists(generated_qrels_dir):
        os.mkdir(generated_qrels_dir)
    next_stage_qrels_path="{}/qrels-irrels.train.tsv".format(generated_qrels_dir)
